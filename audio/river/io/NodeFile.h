		...
		namespace io {
			...
			class NodeFile : public audio::river::io::Node {
				...
				protected:
					 ...
					 * @brief Constructor
					 */
					NodeFile(const std::string& _name, const std11::shared_ptr<const ejson::Object>& _config);
				public:
					static std11::shared_ptr<NodeFile> create(const std::string& _name, const std11::shared_ptr<const ejson::Object>& _config);
					/**
					 * @brief Destructor
					 */
					virtual ~NodeFile();
